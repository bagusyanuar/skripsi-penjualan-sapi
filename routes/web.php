...
Route::get( '/tentang-kami', [\App\Http\Controllers\Member\TentangKamiController::class, 'index'])->name('member.about');
Route::get( '/kontak', [\App\Http\Controllers\Member\KontakController::class, 'index'])->name('member.contact');
